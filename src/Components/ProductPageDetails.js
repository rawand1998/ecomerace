        ...
        <div className="product-details-description">
          ...
          <p className="amount">
            ...
            <div className="amount-btns">
              <FaPlus
                onClick={() => increaAmount(product.amount, product.price)}
                className="amount-inc"
              />
              <FaMinus
                onClick={() => decreaAmount(product.amount, product.price)}
          ...
          <button
            ...
            onClick={() =>
              shoppineCart(product.prorductName, product.amount, product.price)
            }
          >
            Add to cart
          </button>
